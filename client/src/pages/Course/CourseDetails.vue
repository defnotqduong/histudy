<template>
  <div class="pb-[120px] border-b-[1px] border-borderColor">
    ...
    <template v-if="!loading">
          ...
          <div class="grid grid-cols-12 gap-7">
            <div class="col-span-8">
              <div class="p-7 bg-whiteColor rounded-md overflow-hidden shadow-shadow01">
                <img :src="course?.thumb_url" alt="Course Thumbnail" class="w-full object-cover object-center" />
              </div>
                ...
                <div>
                  <div class="pb-2 border-b-[1px] border-borderColor">
                    <div class="collapse collapse-plus">
                      ...
                      <div
                        class="collapse-title text-lg font-bold text-headingColor bg-whiteColor transition-all duration-150 ease-in-out peer-checked:text-primaryColor"
                      >
                      ...
                      <div class="collapse-content peer-checked:bg-whiteColor">
                        <ul>
                          <li class="mb-3">
                            <a
                              href=""
                              class="flex items-center justify-between text-base text-primaryColor transition-all duration-300 hover:text-primaryColor"
                            >
                          ...
                          <li class="mb-3">
                            <a
                              href=""
                              class="flex items-center justify-between text-base text-headingColor transition-all duration-300 hover:text-primaryColor"
                            >
                              <div class="flex items-center justify-center gap-2">
                                <span
                                  ><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" class="w-[18px] h-[18px]">
              ...
              <div class="mt-8 p-7 bg-whiteColor shadow-shadow01 rounded-md overflow-hidden">
                ...
                <div class="prose" v-html="course?.description"></div>
              </div>
              <div class="mt-8 p-7 bg-whiteColor shadow-shadow01 rounded-md overflow-hidden">
                ...
                <div class="flex items-start justify-start">
                  ...
                  <div>
                    <div>
                      <h5 class="text-headingColor text-xl font-extrabold transition-all duration-300 hover:text-primaryColor">
                        <a href="">Claudia Pruitt</a>
                      </h5>
                        ...
                        <li>
                          <span class="py-1 px-2 flex items-center justify-center gap-1 text-sm leading-none rounded-md bg-grayLightColor"
                            ><svg
                              ...
                              fill="currentColor"
                              viewBox="0 0 16 16"
                              class="text-warningColor mb-[2px]"
                            >
                              <path
              ...
              <div class="mt-8 p-7 bg-whiteColor shadow-shadow01 rounded-md overflow-hidden">
                ...
                >
                  ...
                  <svg
                    ...
                    viewBox="0 0 24 24"
                    fill="none"
                    class="w-[14px] h-[14px] absolute top-1/2 -translate-y-1/2 right-0"
                    v-show="isShowReview"
                  >
                    <path
                      fill-rule="evenodd"
              ...
              <div class="mt-20">
                ...
                <div class="flex items-center justify-between">
                  <div class="flex flex-col items-start">
                    <h2 class="text-center text-3xl font-black text-headingColor leading-tight">
                      More Course By <span class="text-primaryColor">Claudia Pruitt</span>
                    </h2>
                  </div>
      ...
      <div class="pt-14">
        <div class="container mx-auto px-4">
          <span class="inline-block px-5 py-2 mb-5 text-sm text-primaryColor font-bold uppercase bg-primaryOpacityColor rounded-full"
            >MORE SIMILAR COURSES</span
          >
          <div class="flex items-center justify-between">
            <div class="flex flex-col items-start">
...
export default defineComponent({
  components: { CourseOverview, SocialListV2, ReviewCard, ButtonV3, CourseCardV2, CourseCardV3, PlayVideoButton, GradientButtonV5, ButtonV5, LoadingV1 },
  setup() {
    ...
    const fetchData = async slug => {
      ...
      instructor.value = res.course.instructor
    ...
    return { slug, course, instructor, category, attachments, chapters, loading, isShowOverview, isShowReview, addToCart, buyNow }
  },
  methods: {
    scrollToTop() {
