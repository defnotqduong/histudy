  ...
  <div class="container mx-auto overflow-hidden">
    <div class="h-screen grid grid-cols-2">
      <div class="col-span-1 py-10 px-16">
        <router-link
          :to="{ name: 'home' }"
          class="text-3xl text-headingColor font-extrabold"
          :style="{ fontFamily: 'Moonkids' }"
          >HiStudy</router-link
        >
      </div>
      <div class="col-span-1 py-6 px-24">
        ...
        <form class="form">
          <div class="input-group">
            ...
            <svg
              ...
              viewBox="0 0 24 24"
              fill="none"
              class="absolute top-1/2 left-2 -translate-y-1/2 w-5 h-5"
            >
              <path
        ...
        <p class="link">
          Do have an account?
          <router-link :to="{ name: 'auth-login' }" rel="noopener noreferrer" href="#" class=""
