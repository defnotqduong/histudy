    ...
    <div class="modal" role="dialog">
      <div class="modal-box bg-white py-6 px-8">
        <div class="modal-action mt-0 mb-2">
          <label for="my_modal_avatar" class="p-2 cursor-pointer">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none">
              <g>
                <path
                  id="Vector"
      ...
      <label class="modal-backdrop" for="my_modal_avatar">Close</label>
    </div>
  </div>
</template>
...
export default defineComponent({
  ...
  setup(props) {
    ...
    return { file, imageSrc, isModalOpen, image, handleFileAvatarUpload, cropImage }
  }
})
</script>
