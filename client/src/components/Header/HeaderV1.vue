    ...
    <div class="py-4">
      <div class="container mx-auto px-4">
        <div class="flex items-center justify-between">
          ...
          <div
            class="w-[50%] flex items-center justify-center border-[1px] border-borderColor rounded-full overflow-hidden relative focus-within:border-headingOpacityColor"
          >
            <input
              type="text"
