  ...
  >
    <div class="container mx-auto px-4">
      <div class="flex items-center justify-center text-white text-sm">
        <span class="px-4 h-7 leading-7 text-xs font-bold bg-primaryColor rounded-full">Limited Time Offer</span>
        <span class="ml-2 flex items-center justify-center gap-[6px]">
          ...
          <p class="text-xs text-whiteOffColor font-bold">Intro price. Get Histudy for Big Sale -95% off.</p>
        </span>
        <div class="ml-7">
          <ButtonV1 :content="'Purchase Now'" :name="'auth-login'" :color="'whiteColor'" />
        </div>
      </div>
    </div>
...
export default defineComponent({
  components: { ButtonV1, CloseButton },
  setup() {
