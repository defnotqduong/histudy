...
import { createLessonAttachment, deleteLessonAttachment } from '@/webServices/attachmentService'
...
export default defineComponent({
  ...
  setup(props) {
    ...
    const onSubmit = async () => {
      ...
      const res = await createLessonAttachment(props.slug, props.chapterId, props.lessonId, formData, progress => {
      ...
      isSubmitting.value = false
      homeStore.onChangeToast({ show: true, type: 'success', message: 'Attachment created Successfully !' })
    ...
    const onDelete = async id => {
      ...
      const res = await deleteLessonAttachment(props.slug, props.chapterId, props.lessonId, id)
