<template>
  <div>
    <div class="relative mb-6">
      ...
      ></div>
      <div class="absolute bottom-2 md:bottom-8 w-full px-4 sm:px-8 md:px-12">
        <div class="flex items-end justify-between">
          <div class="relative w-20 h-20 md:w-[120px] md:h-[120px] p-[2px] sm:p-1 bg-whiteColor border-2 border-primaryOpacityColor rounded-full">
          ...
          <div>
            ...
            <label
              for="filePhotoInput"
              class="block p-2 rounded-full sm:py-2 sm:px-5 text-base text-whiteColor font-semibold sm:rounded-md border-2 border-whiteColor cursor-pointer transtion-all duration-[400ms] ease-in-out hover:bg-primaryColor hover:border-primaryColor hover:translate-y-[-2px]"
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" class="block sm:hidden">
                <path
                  d="M12 16C13.6569 16 15 14.6569 15 13C15 11.3431 13.6569 10 12 10C10.3431 10 9 11.3431 9 13C9 14.6569 10.3431 16 12 16Z"
                  stroke="currentColor"
                  stroke-width="2"
              ...
              <span class="hidden sm:block">Edit Cover Photo</span>
            </label>
          </div>
        </div>
      </div>
