...
Route::group(['prefix' => 'instructor', 'middleware' => 'auth:api'], function () {
    ...
    Route::group(['prefix' => 'category'], function () {
        ...
        Route::post('/{id}/logo', [CategoryController::class, 'updateCategoryLogo']);
    ...
    Route::group(['prefix' => 'assessments'], function () {
        Route::post('/', [AssessmentController::class, 'getInstructorAssessments']);
    });
    ...
    Route::group(['prefix' => 'course/{slug}/assessment'], function () {
        ...
        Route::get('/{id}/questions', [AssessmentController::class, 'getQuestionsForAssessment']);
        Route::patch('/{id}', [AssessmentController::class, 'editAssessment']);
