<template>
  <div class="pt-10 pb-40">
    ...
    >
    <div class="mt-4 mb-8">
      <h5 class="text-lg text-headingColor font-bold">Create Category</h5>
...
export default defineComponent({
  ...
  setup() {
    ...
    const onSubmit = async () => {
      ...
      const res = await createCategory({ name: name.value })
      ...
      if (res.success) {
        homeStore.onChangeToast({ show: true, type: 'success', message: 'Category created Successfully !' })
