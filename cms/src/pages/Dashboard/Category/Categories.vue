        ...
        <table class="table table-pin-rows">
          ...
          <tbody>
            <tr v-for="(category, index) in categories" :key="index">
              ...
              <td>
                <input @change="onChangeCategory(category)" class="switch" type="checkbox" :checked="category.is_published" />
              </td>
              <td>
...
export default defineComponent({
  ...
  setup() {
    ...
    const onDeleteCategory = async id => {
      ...
      homeStore.onChangeToast({ show: true, type: 'success', message: 'Category deleted Successfully !' })
      fetchData()
      isSubmitting.value = false
    }
...
.switch:checked:hover::before {
  box-shadow: 0 0 0px 8px #2f57ef21;
}
