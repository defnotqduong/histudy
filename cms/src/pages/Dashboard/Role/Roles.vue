        ...
        <table class="table table-pin-rows">
          ...
          <tbody>
            <tr v-for="(role, index) in roles" :key="index">
              ...
              <td class="whitespace-nowrap">{{ formatTimeLong(role.created_at) }}</td>
              <td>
                <div class="flex items-center justify-center gap-2">
                  <router-link :to="{ name: 'edit-role', params: { id: role.id } }" class="px-3 py-2 text-primaryColor bg-primaryOpacityColor rounded-md">
