<template>
  <div class="py-20">
    <div class="px-10">
      <h2 class="text-2xl font-extrabold text-headingColor">Create Quiz</h2>
      <form class="form">
        <div for="title" class="input-group">
          <div class="pb-2 text-headingColor font-bold">Quiz title</div>
...
import { createAssessment } from '@/webServices/assessmentService'
