...
export default defineComponent({
  ...
  setup(props) {
    ...
    const description = ref(props.assessment?.description)
    const originalDescription = ref(props.assessment?.description)
    ...
    const onSubmit = async () => {
      ...
      const res = await editAssessment(props.slug, props.id, { description: description.value })
