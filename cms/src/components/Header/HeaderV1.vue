        ...
        <div class="py-4">
            <div class="container mx-auto px-4">
                <div class="flex items-center justify-between">
                    <div class="flex items-center justify-start ml-[-10px]">
                        <div class="px-[10px]">
                            <ul>
                                <li class="has-child-menu">
                                    <a class="flex items-center justify-center gap-1"
                                        ><img src="../../assets/images/en-us.jpg" class="w-5 h-[14px] object-cover object-center mr-[2px]" alt="en-us" />
                                        <span>English</span>
                                    ...
                                    <ul class="sub-menu">
                                        <li>
                                            <a><img src="../../assets/images/fr.jpg" class="w-5 h-[14px] object-cover object-center mr-[2px]" alt="en-us" />Français</a>
                                        </li>
                                        <li>
                                            <a><img src="../../assets/images/de.jpg" class="w-5 h-[14px] object-cover object-center mr-[2px]" alt="en-us" />Deutsch</a>
                                        </li>
                                    </ul>
                                </li>
                            </ul>
                    ...
                    <div class="w-[50%] flex items-center justify-center border-[1px] border-borderColor rounded-full overflow-hidden relative focus-within:border-headingOpacityColor">
                        <input
                            type="text"
                            placeholder="Search Course"
                            class="flex-1 outline-none border-none leading-[46px] pl-5 pr-16 text-headingColor text-base font-semibold placeholder:text-bodyColor"
                        />
                        <button class="absolute top-0 right-0 w-14 h-full flex items-center justify-center text-blackColor hover:text-primaryColor">
                    ...
                    <div class="flex items-center justify-center gap-3 mr-[-10px]">
                        <div class="px-[10px]">
                            <ul>
                                <li class="text-headingColor text-base font-bold cursor-pointer transitin-all duration-[400ms] hover:text-primaryColor">
                        ...
                        <div class="w-[1.5px] h-8 bg-borderColor"></div>
                        <div class="px-[10px]">
                            <ul>
                                <li class="user-menu">
                                    <a class="flex items-center justify-center gap-2 text-headingColor text-base font-bold cursor-pointer transitin-all duration-[400ms] hover:text-primaryColor">
                                        ...
                                        <span class="mt-1 line-clamp-1">Admin</span>
                                    </a>
                                    <div class="user-menu-list-wrapper">
                                        <div class="p-4">
                                            <div class="pb-5 flex items-center justify-start">
                                                ...
                                                <div class="flex-1">
                                                    <h5 class="text-base text-heading font-bold line-clamp-1">Phan Quang Dương Siêu Cấp VjpPro</h5>
                                                    <button>
                                                        <router-link
                                                            :to="{ name: 'home' }"
...
.sub-menu {
    ...
    border-radius: 6px;
    background: white;
    box-shadow: 0px 6px 34px rgba(181, 182, 185, 0.41);
    border-top: 1px solid rgba(220, 218, 230, 0.31);
    transition: opacity 0.3s linear;
}

.sub-menu.hover-reverse {
    left: auto;
    right: 0;
    min-width: 120px;
}
...
.user-menu-list-wrapper {
    ...
    transition: clip 0.5s linear, opacity 0.3s linear;
}
