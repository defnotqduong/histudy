<template>
  <div class="flex items-center gap-3">
    <button @click.prevent="redirect" class="px-4 h-10 min-h-10 text-sm text-whiteColor bg-blackColor rounded-md">Quiz</button>
    <button
...
export default defineComponent({
  ...
  setup(props) {
    ...
    const redirect = () => {
      router.push({ name: 'course-quiz', params: { slug: props.slug } })
    }
